...
-- Exercicio 4 --  alunos que têm salário maior que 410 e que costumam se preparar com
-- frequência (regularmente) para os exames

CREATE OR REPLACE FUNCTION get_count_students_salary_above_410_and_regular_preparation()
RETURNS INTEGER AS $$
DECLARE
